...
<head>
    ...
    <link rel="shortcut icon" href="img/BizShield64px.png" type="image/x-icon" />
    <meta name="theme-color" content="#367fa9">
    <link rel="apple-touch-icon" sizes="180x180" href="img/BizShield64px.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="img/BizShield64px.png">
    <link rel="icon" type="image/png" sizes="96x96" href="img/BizShield64px.png">
    <meta name="msapplication-TileColor" content="#367fa9">
    <meta name="msapplication-TileImage" content="img/BizShield64px.png">
	...
	<link rel="stylesheet" type="text/css" href="style/Biz.css">
    <link rel="icon" type="image/png" sizes="160x160" href="img/BizShield64px.png" />
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="img/BizShield64px.png" class="img-responsive" alt="BizShield logo" style="display: table; table-layout: fixed;" />
                </div>
